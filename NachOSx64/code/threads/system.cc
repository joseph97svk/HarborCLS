...
std::pair<size_t, nchs::map<size_t, Semaphore*>*>* systemSemaphores;

nchs::map<int, SocketInfo*>* systemSockets;

nchs::ProcessTable* processTable;
...
// 2007, Jose Miguel Santos Espino
    ...
    systemSemaphores = new std::pair<size_t, nchs::map<size_t, Semaphore*>*>();
    systemSemaphores->first = 0;
    systemSemaphores->second = new nchs::map<size_t, Semaphore*>;
    processTable = new nchs::ProcessTable();

    systemSockets = new nchs::map<int, SocketInfo*>;
#endif
#ifdef FILESYS_NEEDED
...
// 2007, Jose Miguel Santos Espino
    ...
    delete machine;
    delete memMap;
    delete systemSemaphores->second;
    delete systemSemaphores;
    delete systemSockets;
#endif
