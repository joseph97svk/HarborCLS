...
namespace HarborCLS {
  ...
  class ConnectionListener : public Listener<std::shared_ptr<TcpSocket>, TcpSocket> {
  public:
    /**
     ...
     */
    ConnectionListener(Queue<std::shared_ptr<TcpSocket>> *connectionsQueue, std::shared_ptr<TcpSocket> socket,
                       std::shared_ptr<TcpSocket> stopCondition, std::shared_ptr<TcpSocket> handlerStopCondition,
                       unsigned int port);
